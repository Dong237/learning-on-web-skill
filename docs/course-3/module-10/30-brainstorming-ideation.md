...
本文深入探讨AI产品经理必备的头脑风暴与构思技能。介绍经典方法(6-3-5、SCAMPER、思维导图)与2026年中国AI辅助构思工具(通义千问、Kimi、文心一言)的结合应用,涵盖远程协作、发散-收敛思维转换、创意管理全流程。通过豆包、Kimi等真实案例,展示如何在20分钟内产生100+个AI产品创意,并通过结构化评估筛选出可落地的创新方案。
