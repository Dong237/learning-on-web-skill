...
|---------|---------------|----------|----------|-----------|---------|
| **豆包（字节）** | 社交内容+用户行为数据 | 10亿+用户、[DAU破1亿](https://www.ithome.com/0/907/726.htm) | 高（抖音独家数据） | 推荐算法优化、内容生成 | 基于行业观察的数据资产评估 |
| **Kimi（月之暗面）** | 长文本对话数据 | [2025年底MAU约900万](https://finance.sina.cn/stock/jdts/2026-01-30/detail-inhkakfi7033558.d.html) | 中高（长文本场景独特） | 长文档理解、知识问答 | 基于行业观察的数据资产评估 |
| **商汤科技** | 医疗影像标注数据 | 医疗影像数据积累 | 极高（医疗数据稀缺） | AI辅助诊断 | [商汤医疗投后估值超30亿](https://www.yicai.com/news/102915273.html) |
| **云知声** | 垂直行业语音数据 | 语音数据资源积累 | 高（方言+行业术语） | 智能客服、语音助手 | [公司估值约90亿元](https://www.stcn.com/article/detail/1161802.html) |
...
|---------|------------|------------|---------------|--------------|--------------|
| **龙猫数据** | 计算机视觉、自动驾驶 | 自动驾驶厂商 | 基于行业观察 | 基于行业观察 | 自动驾驶场景专业化 |
| **数据堂** | [NLP、语音识别](https://blog.csdn.net/weixin_64261932/article/details/128032888) | 科大讯飞等 | [新三板上市企业](https://blog.csdn.net/weixin_64261932/article/details/128032888) | [5000名以上](https://blog.csdn.net/weixin_64261932/article/details/128032888) | 多语种标注（100+语言） |
| **云测数据** | 多模态标注 | [世界500强企业](https://blog.csdn.net/weixin_64261932/article/details/128032888) | 基于行业观察 | 基于行业观察 | AI辅助标注工具 |
| **星尘数据** | 医疗AI标注 | 基于行业观察 | 基于行业观察 | 基于行业观察 | 医疗专家团队 |
| **曼孚科技** | 金融风控标注 | 基于行业观察 | 基于行业观察 | 基于行业观察 | 金融业务理解 |
...
| **交易所** | **成立时间** | **主管单位** | **交易规模** | **特色品种** | **代表案例** |
|-----------|------------|------------|---------------------|------------|------------|
| **贵阳大数据交易所** | 2015.4 | 贵州省政府 | [2025年目标¥100亿](https://m.gmw.cn/2023-08/04/content_1303467539.htm) | 政务数据、工业数据 | 基于公开报道 |
| **上海数据交易所** | 2021.11 | 上海市政府 | [2024年超¥50亿](https://www.chyxx.com/industry/1235856.html) | 金融数据、医疗数据 | 银行信贷风控数据 |
| **北京国际大数据交易所** | 2021.3 | 北京市政府 | [累计近¥100亿](https://www.beijing.gov.cn/ywdt/yaowen/202501/t20250126_3999091.html) | 科技数据、文化数据 | 自动驾驶训练数据 |
| **深圳数据交易所** | 2021.11 | 深圳市政府 | [2023年底累计¥65亿](https://bg.qianzhan.com/report/detail/300/240514-1407291f.html) | 跨境数据、供应链数据 | 港澳物流数据交易 |
| **浙江大数据交易中心** | 2016.1 | 浙江省政府 | 基于行业观察 | 电商数据、制造数据 | 工业互联网数据 |
...
|---------|-----------|------------|------------|------------|
| **银行联合风控** | [金融机构联合建模](https://www.secrss.com/articles/17889) | 跨行欺诈检测 | [风控模型AUC提升12%](https://zhidx.com/p/200599.html) | [微众银行FATE平台](https://zhidx.com/p/200599.html) |
| **医疗AI诊断** | 医疗机构合作 | 罕见病识别 | 提升诊断能力 | 基于隐私计算技术 |
| **智能制造** | [智能制造企业](http://www.enet16.com/article/2025/0520/A202505202216.html) | 供应链预测 | 提升生产效率 | 基于AI技术平台 |
| **广告联盟** | 电商平台合作 | 用户画像互补 | 提升营销效果 | 基于联邦学习技术 |
...
```
2023.5 内测 ──▶ 2023.8 公测 ──▶ 2024.1 爆发增长 ──▶ 2025.12 行业领先
│                │                │                   │
│                │                │                   │
▼                ▼                ▼                   ▼
种子用户阶段   快速增长期      持续扩张期           DAU破1亿
│                │                │                   │
基础对话数据   抖音生态数据    多场景数据           全场景数据覆盖
│                │                │                   │
基础模型能力   能力提升        场景优化             多模态发展
│                │                │                   │
免费策略       抖音导流         视频脚本生成应用      企业服务变现
│                │                │                   │
▼                ▼                ▼                   ▼
...
来源：[36氪](https://eu.36kr.com/zh/p/3609313072153862)、[IT之家](https://www.ithome.com/0/907/726.htm)
```
...
| **成立时间** | 2021.11 |
| **主管单位** | 上海市政府 |
| **交易规模** | [2024年超¥50亿](https://www.chyxx.com/industry/1235856.html) |
| **上架数据产品** | 数千个数据产品（金融、医疗、交通、制造） |
...
| **DAU** | [2025年12月破1亿](https://www.ithome.com/0/907/726.htm) |
| **核心数据资产** | 抖音用户行为、今日头条阅读数据、用户对话历史 |
| **数据飞轮** | 抖音导流 → 用户使用 → 对话数据 → 模型优化 → 更多用户 |
| **差异化数据** | 短视频创作数据（脚本、热点话题） |
| **数据合规** | 算法备案、用户数据加密存储 |
| **商业化路径** | 免费吸引用户 → 企业服务变现（视频脚本生成API） |
| **竞争优势** | 字节生态数据闭环，竞品难以复制 |

### 8.3 数据生态的商业机会

**5大掘金方向（2026-2028）：**

| **方向** | **市场空间** | **创业机会** | **进入门槛** | **竞争格局** |
|---------|------------------|------------|------------|------------|
| **1. 垂直行业数据标注** | 大规模市场 | 医疗、法律、金融专业标注 | 中（需行业专家） | 蓝海（巨头未重点布局） |
| **2. 合成数据生成** | 快速增长市场 | Synthetic Data工具、虚拟场景 | 高（需AI技术） | 新兴市场 |
| **3. 数据合规服务** | 持续增长市场 | 数据分级工具、自动化合规检测 | 中（需法律+技术） | 增长快 |
| **4. 联邦学习平台** | 大规模市场 | 隐私计算中间件、跨域协作平台 | 高（技术门槛高） | 巨头主导，细分机会 |
| **5. 数据资产评估** | 新兴市场 | 数据定价模型、数据审计服务 | 中（需评估体系） | 新兴市场 |
...
| **案例类型** | **违规行为** | **后果** | **教训** |
|---------|------------|---------|---------|
| **短视频App** | 未经授权采集通讯录 | 下架整改、罚款、用户流失 | 合规审查前置，不能上线后补 |
| **AI换脸App** | 人脸数据未加密存储 | 被黑客攻击、数据泄露、刑事立案 | 敏感数据必须加密+权限控制 |
| **医疗AI公司** | 医疗数据未脱敏直接训练 | 医院终止合作、业务受损 | 数据脱敏是底线，不可妥协 |
| **出海AI产品** | 中国用户数据传境外未评估 | 被网信办约谈、强制整改、融资受阻 | 数据出境必须走合规流程 |
